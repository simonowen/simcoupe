...
// The original TurboMON fixed font, still used for profiling/status text
const GUIFONT sFixedFont = { 6, 8, 9, 32, 129, true,  abFixedFont };
const GUIFONT sPropFont  = { 6, 8, 9, 32, 129, false, abFixedFont };
