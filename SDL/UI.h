...
// SDL_USEREVENT codes for external events (macOS menus)
#define UE_BASE                 1000
...
#define UE_SAVESCREENSHOT       (UE_BASE+10)
#define UE_PAUSE                (UE_BASE+11)
#define UE_TOGGLETURBO          (UE_BASE+12)
#define UE_RELEASEMOUSE         (UE_BASE+13)
#define UE_OPTIONS              (UE_BASE+14)
#define UE_IMPORTDATA           (UE_BASE+15)
#define UE_EXPORTDATA           (UE_BASE+16)
#define UE_RECORDGIF            (UE_BASE+17)
#define UE_RECORDGIFLOOP        (UE_BASE+18)
#define UE_RECORDGIFSTOP        (UE_BASE+19)
#define UE_RECORDWAV            (UE_BASE+20)
#define UE_RECORDWAVSEGMENT     (UE_BASE+21)
#define UE_RECORDWAVSTOP        (UE_BASE+22)
